...
luci-app-filetransfer ddns-scripts_aliyun luci-app-koolproxyR  \
luci-app-arpbind luci-app-ramfree \
libericstools libmbedtls kmod-ipt-tproxy iptables-mod-ipopt wget unzip resolveip luci-lib-jsonc kmod-ipt-ipopt gargoyle-firewall-util libiptbwctl qos-gargoyle kmod-ipt-ndpi kmod-ipt-webmon \
